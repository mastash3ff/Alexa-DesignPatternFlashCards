...
exports.handler = function (event, context) {
	...
	if (event.session.application.applicationId !== config.appId) {
        ...
        context.fail("Exception in event.request: " + e);
    }
};
...
var CARD_TITLE = "Design Pattern Flash Cards"; 
...
function getWelcomeResponse(callback) {
    ...
    var sessionAttributes = {},
        ...
        speechOutput = "I will ask you " + GAME_LENGTH.toString()
            + " random questions, try to get as many right as you can by saying the answer. Let's begin. ",
...
function populateRoundAnswers(gameQuestionIndexes, correctAnswerIndex, correctAnswerTargetLocation) {
    ...
    for (var j = 1; j < answersCopy.length; j++){
        ...
        var tmp = answersCopy[index];
        answersCopy[index] = answersCopy[rand];
        answersCopy[rand] = tmp;
    }
...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        var speechOutput = "Sorry, your answer is not in our list of design patterns. " + reprompt;
        ...
        if (answerSlotValid && intent.slots == null){
            speechOutputAnalysis += "The correct answer is " + correctAnswerText + ". ";
        }
        else if (answerSlotValid && intent.slots.Answer.value == correctAnswerText) {
            currentScore++;
...
function handleGetHelpRequest(intent, session, callback) {
    ...
    var speechOutput = "I will provide you " + GAME_LENGTH + " design pattern descriptions. Respond with the design pattern's name. "
        + "For example, abstract factory. To start a new game at any time, say, start game. "
